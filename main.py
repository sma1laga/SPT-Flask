...
from pages.process_chain_plot import process_chain_bp
...
from pages.training.training_page import training_page_bp
...
from pages.training.processing_chain import training_processing_chain_bp
...
def create_app():
    ...
    app.register_blueprint(process_chain_bp, url_prefix="/process_chain_plot")
    ...
    app.register_blueprint(training_page_bp,        url_prefix="/training")
